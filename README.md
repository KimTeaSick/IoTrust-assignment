...
즐겨찾기는 staging만 분기 처리 되어 있습니다.

리스트는 모든 환경에서 동일하게 분기 되어 있습니다.
...
react query에서 key를 factory 형태로 관리해서 확장성을 증가시켰습니다.
...
시스템 에이전트를 설정해서 아웃풋의 일관성을 지켜습니다. 또한 프롬프트를 작성할때, 모호한 단어는 제거하고, 정확한 목표를 제시하는 AI 친화적으로 작성 <br />
